...
- [design-patterns](../design-patterns/SKILL.md) - choosing and implementing GoF and idiomatic patterns (traits, enums, typestate in Rust; equivalent idioms in other languages).
- [security-review](../security-review/SKILL.md) — multi-language security-audit checklists (unsafe/FFI/concurrency/panic-DoS finders); the Trail of Bits-derived Rust deep-dive lives at `references/rust/` inside this skill.
