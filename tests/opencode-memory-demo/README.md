...
This project loads the local `0.4.0` source build from `../../dist/index.js` and keeps its memory store under `.memory-data/`, isolated from the parent repository store.
